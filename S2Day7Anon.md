...
- This is because they are doing illegal things so they try to be anonymous
...
4. Random Chain
### Dynamic Chain
- is That way the proxy Servers are chained is as the proxy list given.
